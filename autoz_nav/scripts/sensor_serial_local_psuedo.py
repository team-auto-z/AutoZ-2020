...
def main():
	...
	while not rospy.is_shutdown():
		...
		imu_data.orientation.x = 0.1 ##angular[3]
		imu_data.orientation.y = 0.1 ## angular[4]
		imu_data.orientation.z = 0.1 ##angular[5]

		imu_data.linear_acceleration.x = 0.01# linear[6]
		imu_data.linear_acceleration.y = 0# linear[7]
		imu_data.linear_acceleration.z = 0#linear[8]
