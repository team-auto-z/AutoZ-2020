...
class KeyTeleop():
    ...
    def __init__(self, interface):
        ...
        self._pub_cmd = rospy.Publisher('twist', Twist,queue_size=10)



        self._hz = rospy.get_param('~hz', 50)

        self._num_steps = rospy.get_param('~turbo/steps', 1000)
