...
def main():
	...
	while not rospy.is_shutdown():
		...
		if data[0]=='#':
			...
			imu_data.orientation.x = angular[3]
			imu_data.orientation.y = angular[4]
			imu_data.orientation.z = angular[5]

			imu_data.linear_acceleration.x = linear[6]
			imu_data.linear_acceleration.y = linear[7]
			imu_data.linear_acceleration.z = linear[8]
			...
			gps_data.latitude  = linear[0]
			gps_data.longitude = linear[1]
